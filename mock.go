...
type IsOptionTypeArgument struct {
	t interface{}
}
func OptionOfType(t interface{}) *IsOptionTypeArgument {
	return &IsOptionTypeArgument{t: t}
}
...
func (args Arguments) Diff(objects []interface{}) (string, int) {
	...
	for i := 0; i < maxArgCount; i++ {
		...
		} else if reflect.TypeOf(expected) == reflect.TypeOf((*IsOptionTypeArgument)(nil)){
			t := expected.(*IsOptionTypeArgument).t
